package com.example.admin.studio_didicar.Navi;
...
import com.example.admin.studio_didicar.NaviActivity;
import com.example.admin.studio_didicar.R;
    ...
    private void addCustomizedLayerItems() {
        ...
        if (mBNRoutePlanNode != null) {
            item1 = new CustomizedLayerItem(mBNRoutePlanNode.getLongitude(), mBNRoutePlanNode.getLatitude(),
                    mBNRoutePlanNode.getCoordinateType(), getResources().getDrawable(R.drawable.ic_launcher_foreground),
